            ...
            showCommonDialogWithTwoOptions(
              ...
              _inquiryBloc.add(QuotationHeaderSaveCallEvent(
                  ...
                  QuotationHeaderSaveRequest(
                      ...
                      DiscountPer:_maindis_per.text.toString(),
                      DeliveryDays: "0",
                      Validity: "30"
                  )));
            });
...
/*
  ...
  List<double> UpdateHeaderDiscountCalculation(
    ...
    if (tempproductList != null) {
      ...
      Tot_after_acurabath_dis = Tot_BasicAmount - b;
      ...
      /*double AcurabathDis = _maindis_per.text.isNotEmpty ? double.parse(_maindis_per.text) : 0.00;
      double AcurabathDisAmnt = _maindis_per_amnt.text.isNotEmpty
          ? double.parse(_maindis_per_amnt.text)
          : 0.00;*/
